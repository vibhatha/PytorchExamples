# -*- coding: utf-8 -*-
"""model_parallel_tutorial.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rqKZ_3nbTzDa7vuNoP8k73b99XQdx1l8
"""
...
print("Single Node Time {}".format(rn_mean))
print("Model Parallel Time {}".format(mp_mean))
print("Pipeline 20 Mean {}".format(pp_mean))
print("Pipeline Split Times {}".format(pp_means))
