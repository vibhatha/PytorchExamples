...
def train(model):
    ...
    for _ in range(num_batches):
        ...
        with open(file_name, "a+") as fp:
            statement1 = "{},{},{},{},{} \n".format(split_value,fw_time, label_copy_time, bw_time, opt_time)
            fp.write(statement1)
            
        print("Split:{} :: FW {}, LBL_CP {}, BW {}, OPT {}".format(split_value, fw_time, label_copy_time, bw_time, opt_time))
